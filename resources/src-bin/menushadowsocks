...
# Function to print rainbow text
        ...
        shadowsocks_members() {
            ...
            echo -e "${green}    .:::. SHADOWSOCKS MEMBERS .:::.        ${neutral}"
            echo -e "${orange}─────────────────────────────────────────${neutral}"
    ...
    if [ $account_count -eq 0 ]; then
        echo -e "   ${red}No active Shadowsocks accounts.${neutral}"
        echo -e "${orange}─────────────────────────────────────────${neutral}"
        echo -e "   Press enter to return to the menu"
        read
        return
    fi
    echo -e " List of Shadowsocks Accounts:"
    echo -e "${orange}─────────────────────────────────────────${neutral}"
    echo "┌──┬────────────┬──────┬──────┬───┬──────┐"
    echo "│no│ username   │ exp  │quota │ip │usage │"
    echo "├──┼────────────┼──────┼──────┼───┼──────┤"

    grep -E "^### " "/etc/xray/shadowsocks/.shadowsocks.db" | nl -s ' ' | while read -r line; do
    ...
    read
        ...
        change_shadowsocks_limit() {
            clear
            echo -e "${orange}─────────────────────────────────────────${neutral}"
            echo -e "${green}  .:::. CHANGE SHADOWSOCKS LIMIT .:::.${neutral}"
            echo -e "${orange}─────────────────────────────────────────${neutral}"
            echo -e " List of Shadowsocks Accounts:"
            echo -e "${orange}─────────────────────────────────────────${neutral}"
    if [ ! -e "/etc/xray/shadowsocks/.shadowsocks.db" ]; then
        echo -e "   ${red}No Shadowsocks accounts registered.${neutral}"
        echo -e "${orange}─────────────────────────────────────────${neutral}"
        echo -e "   Press enter to return to menu"
        read
        return
    ...
    read
        ...
        shadowsocks_details() {
            clear
            echo -e "${orange}─────────────────────────────────────────${neutral}"
            echo -e "${green}     .:::. SHADOWSOCKS DETAIL .:::.     ${neutral}"
            echo -e "${orange}─────────────────────────────────────────${neutral}"
            ...
            while IFS= read -r line; do
                ...
                password=$(echo $line | cut -d ' ' -f 4 | sort -u)
...
custom_uuid_shadowsocks() {
    clear
    echo -e "${orange}─────────────────────────────────────────${neutral}"
    echo -e "  ${green}.:::. CUSTOM SHADOWSOCKS UUID .:::.${neutral}"
    echo -e "${orange}─────────────────────────────────────────${neutral}"
    if [ ! -e "/etc/xray/shadowsocks/.shadowsocks.db" ]; then
        echo -e "   ${red}No Shadowsocks accounts registered.${neutral}"
        echo -e "${orange}─────────────────────────────────────────${neutral}"
    ...
    },{"password": "'"$new_uuid"'","method": "'"$method"'","email": "'"$user"'"}' $config_file
    ...
    read
        ...
        display_shadowsocks_menu() {
            clear
            echo -e "${orange}─────────────────────────────────────────${neutral}"
            echo -e "${green}     .:::. SHADOWSOCKS MANAGER .:::.        ${neutral}"
            echo -e "${orange}─────────────────────────────────────────${neutral}"
            echo -e "   ${green}1.${neutral} Create Shadowsocks Account"
            echo -e "   ${green}2.${neutral} Delete Shadowsocks Account"
            echo -e "   ${green}3.${neutral} Renew Shadowsocks Account"
            echo -e "   ${green}4.${neutral} Check Shadowsocks Login Account"
            echo -e "   ${green}5.${neutral} List Shadowsocks Members"
            echo -e "   ${green}6.${neutral} Change Shadowsocks Account Limit"
            echo -e "   ${green}7.${neutral} View Shadowsocks Account Details"
            echo -e "   ${green}8.${neutral} Create Trial Shadowsocks Account"
            echo -e "   ${green}9.${neutral} Custom Shadowsocks UUID"
            echo -e "   ${green}x.${neutral} Exit Shadowsocks Manager"
            echo -e "${orange}─────────────────────────────────────────${neutral}"
            print_rainbow "─────────────────────────────────────────"
            echo -e "          ${orange}───${green}───${yellow}───${blue}───${purple}───${red}───${neutral}"
            echo -e ""
            echo -e ""
            read -p " Enter your choice (1-9) or type 'x' to quit: " shadowsocks_choice
