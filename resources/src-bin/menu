...
if [ $status_code -eq 200 ]; then
    ...
    if [ $expiry_date -gt $current_date ]; then
        ...
        display_menu() {
            ...
            echo -e "      \e[38;5;196m• \e[0mIP        : $(wget -qO- ipv4.icanhazip.com 2>/dev/null || curl -s ipv4.icanhazip.com || echo "Unable to detect IP")"
            ...
            print_rainbow "       └───────────────────────────────┘"
            echo -e "   ${orange}─────────────────────────────────────────${neutral}"
            echo -e "     ${green}1.${neutral}$(print_names "SSH OVPN MANAGER")${neutral} ${green}4.${neutral}$(print_names "TROJAN MANAGER")${neutral}"
            echo -e "     ${green}2.${neutral}$(print_names "VMESS MANAGER")${neutral}    ${green}5.${neutral}$(print_names "SHDWSK MANAGER")${neutral}"
            echo -e "     ${green}3.${neutral}$(print_names "VLESS MANAGER")${neutral}    ${green}6.${neutral}$(print_names "OTHER SETTINGS")${neutral}"
            echo -e "   ${orange}─────────────────────────────────────────${neutral}"
            print_rainbow "   ┌─────────────────────────────────────────┐"
            ...
            echo -e ""
            echo -e ""
            read -p " Enter your choice (1-6) or type 'x' to quit:" choice
